...
export const gridItems = [
  ...
  {
    id: 2,
    title: "We adapt to your time zone for seamless communication.",
    description: "",
  ...
  {
    id: 4,
    title: "Tech enthusiasts driven by innovation and development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building innovative apps that push boundaries.",
  ...
  {
    id: 6,
    title: "Do you want to start a project with us?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
